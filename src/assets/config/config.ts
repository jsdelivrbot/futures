...
/*----------------------------------------图片地址ip-----------------------------------------*/
export const IMAGE_IP='';
/*----------------------------------------文件服务器地址----------------------------------------*/
export const FILE_SERVE_URL = 'http://172.16.19.86/kit_file_server/';//文件服务:测试环境

/*----------------------------------------app版本升级服务地址----------------------------------------*/
export const APP_VERSION_SERVE_URL = 'http://47.97.60.28:8000/api/v1/';//app版本升级服务;测试环境,查询app最新版本号,更新日志等信息.
...
export const APK_DOWNLOAD = 'http://md-resource.oss-cn-hangzhou.aliyuncs.com/download/ddy.apk';//android apk下载完整地址,用于android本地升级
